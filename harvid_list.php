...
$search_result = $db->getAllVideosByBatchSubjectChapter($_GET['batch_id'], $_GET['subject_id'], $_GET['chapter_id']);
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><?php
                                                if (strlen($row['source']) > 4) {
                                                    echo '<a href="https://www.youtube.com/watch?v=' . $row['source'] . '" >Open Link</a>';
                                                } ?>
                                            </li>
                                            <li>
                                                <a href="video_att.php?batch_id=<?php echo $row['batch_id'] ?>&video_id=<?php echo $row['source'] ?>&id=<?php echo $row['id'] ?>" >Attendance</a>
                                            </li>
                                            <li>
                                                <a href="harvid_edit.php?video_id=<?php echo $row['id'] ?>" >Edit</a>
                                            </li>
